...
//			label		,units,prm						,type			,chmod			,def	,min	,max		,step	,bigstep,power,save
...
parametres(ipadr		,""	,fp.fpSet.ipadr				,ipAdrFrmt		,chmodAlways	,0xC0A8010A	,0		,0xFFFFFFFF	,1		,1		,0	,prmEeprom) /* 192.168.1.10 */
parametres(netmask		,""	,fp.fpSet.netmask			,ipAdrFrmt		,chmodAlways	,0xFFFFFF00	,0		,0xFFFFFFFF	,1		,1		,0	,prmEeprom) /* 255.255.255.0 */
parametres(gateway		,""	,fp.fpSet.gateway			,ipAdrFrmt		,chmodAlways	,0xC0A80101	,0		,0xFFFFFFFF	,1		,1		,0	,prmEeprom) /* 192.168.1.1 */
