...
const uint32_t fwinfoBuild    = 818;
const char fwinfoVersion[] = {"2.0.0.818"};
const char fwinfoDate[]    = {"03.10.2017"};
const char fwinfoTime[]    = {"14:03:11"};
