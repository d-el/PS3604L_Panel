...
const uint32_t fwinfoBuild    = 808;
const char fwinfoVersion[] = {"2.0.0.808"};
const char fwinfoDate[]    = {"28.09.2017"};
const char fwinfoTime[]    = {"02:39:37"};
