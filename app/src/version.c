...
const uint32_t fwinfoBuild    = 934;
const char fwinfoVersion[] = {"2.0.0.934"};
const char fwinfoDate[]    = {"05.10.2017"};
const char fwinfoTime[]    = {"11:20:15"};
