...
const uint32_t fwinfoBuild    = 2094;
const char fwinfoVersion[] = {"2.0.0.2094"};
const char fwinfoDate[]    = {"26.01.2018"};
const char fwinfoTime[]    = {"14:48:40"};
