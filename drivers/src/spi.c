...
static void *flushcb_arg, *setbufcb_arg;
...
void spi_init(spiDiv_t divClock){
	...
	LCD_SPI->CR1 |= divClock << SPI_CR1_BR_Pos;	// BR
...
void spi_initBlock(void){
	...
	LCD_DMA_STREAM->CR |= DMA_SxCR_PL_0;								// Priority level Medium
